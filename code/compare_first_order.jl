...
@time outsqp1 = mixSQP(L,lowrank = "none", eps = 1e-8, maxqpiter = 200,
                       maxiter = 200, verbose = true, nullprior = 0);
@time outsqp2 = mixSQP(L,lowrank = "qr", eps = 1e-8, maxqpiter = 200,
                       maxiter = 200, verbose = true, nullprior = 0);
...
writecsv("simdata-n=20000-m=20.csv",L);
